...
export interface IHealthClient {
    ...
    watch(request: health_pb.HealthCheckRequest, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<health_pb.HealthCheckResponse>;
}
